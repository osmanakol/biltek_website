...
morgan.token('remote-addr',function (req, res) { if (req.headers['x-forwarded-for']==undefined) return req.connection.remoteAddress; else return req.headers['x-forwarded-for'].toString()  })
morgan.token('date', ()=> {
